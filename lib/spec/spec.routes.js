...
describe('Server', function () {
  ...
  describe('GET /api/v1/orders/:id', function () {
    var data = {};
    beforeAll(function (done) {
      Request.get('http://localhost:3001/api/v1/orders/1', function (error, response) {
        data.status = response.statusCode;
        done();
      });
    });
  ...
  describe('PUT /api/v1/orders/:id', function () {
    var data = {};
    beforeAll(function (done) {
      Request.put('http://localhost:3001/api/v1/orders/1', function (error, response) {
        data.status = response.statusCode;
        done();
      });
    });
  ...
  describe('DELETE /api/v1/orders/:id', function () {
    var data = {};
    beforeAll(function (done) {
      Request.get('http://localhost:3001/api/v1/orders/1', function (error, response, body) {
        data.status = response.statusCode;
